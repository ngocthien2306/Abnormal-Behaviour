...
class Ui_MainWindow(object):
    ...
    def training_model(self):
        ...
        if path_file == '' or path_file == None:
                ...
                return
        #'trainning_data.csv' 
        raw_data = pd.read_csv("datas/" + str(path_file))    
    ...
    def loadDataStudent(self):
        raw_data = pd.read_csv('datas/exam_data.csv')
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnCreate.setText(_translate("MainWindow", "Get Training Data"))
        ...
        self.path.setText(_translate("MainWindow", "training_data.csv"))
        self.label_18.setText(_translate("MainWindow", "Train:"))
        
        self.label_19.setText(_translate("MainWindow", "Test:"))
        self.label_20.setText(_translate("MainWindow", "Info:"))
